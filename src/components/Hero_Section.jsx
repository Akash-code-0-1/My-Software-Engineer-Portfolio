            ...
            <div className="flex flex-col lg:flex-row items-center justify-center gap-8 mt-8 lg:mt-16">
                ...
                <div className="flex-shrink-0">
                    <img
                        src={profile_pic}
                        alt="Profile Picture"
                        className="h-[200px] w-[200px] sm:h-[300px] sm:w-[300px] md:h-[300px] md:w-[300px] lg:h-[300px] lg:w-[300px] xl:h-[400px] xl:w-[400px] object-cover rounded-full shadow-lg dark:bg"
                    />
                </div>
